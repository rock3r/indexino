...
val metalavaOutput = layout.buildDirectory.file("metalava/indexino-compose-decoration-current.txt")
val reviewedMetalavaSignature =
    rootProject.layout.projectDirectory.file("api/indexino-compose-decoration/current.txt")
...
val metalavaCheckSignature by tasks.registering {
    ...
    doLast {
        check(
            ...
            "Generated signature differs from api/indexino-compose-decoration/current.txt"
        }
    }
}
...
tasks.named<Jar>("jar") {
    ...
    doFirst {
        ...
        manifest.attributes["Indexino-Plugin-Id"] = "dev.sebastiano.compose-decoration"
        ...
        manifest.attributes["Indexino-Plugin-Display-Name"] = "Compose decoration"
        manifest.attributes["Indexino-Plugin-Produced-Namespaces"] =
            "dev.sebastiano.compose-decoration"
    }
}

mavenPublishing {
    coordinates(group.toString(), "indexino-compose-decoration", version.toString())

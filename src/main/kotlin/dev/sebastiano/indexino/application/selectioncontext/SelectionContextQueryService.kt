...
@Serializable
internal data class SelectionContextQueryRow(
    val file: String,
    val line: Int,
    val column: Int,
    val callee: String,
    ...
    val selectionContainers: List<dev.sebastiano.indexino.core.record.SelectionContainerRef>,
    val disableSelection: dev.sebastiano.indexino.core.record.DisableSelectionRef? = null,
...
internal class SelectionContextQueryService(
    ...
    private fun recordToRow(
        rawKey: String,
        record: dev.sebastiano.indexino.core.record.CodeIndexRecord,
...
internal object SelectionContextJsonlFormatter {
...
internal class PresetConfigLoader {

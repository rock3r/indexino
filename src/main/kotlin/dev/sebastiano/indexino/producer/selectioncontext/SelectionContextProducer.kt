package dev.sebastiano.indexino.producer.selectioncontext
...
import dev.sebastiano.indexino.core.record.DisableSelectionRef
...
internal class SelectionContextProducer(private val walker: SelectionWalker = SelectionWalker()) :
    IndexProducer {
